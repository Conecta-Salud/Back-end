...
@ApplicationScoped
public class EstablishmentTypeCatalogWriter {

    private final EntityManager em;

    public EstablishmentTypeCatalogWriter(EntityManager em) {
        this.em = em;
    }

    @Transactional
    public CatalogWriteResult ensure(String name) {
        String safeName = requireText(name, "establishmentTypeName");
